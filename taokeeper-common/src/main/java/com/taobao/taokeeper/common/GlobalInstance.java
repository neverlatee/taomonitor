...
public class GlobalInstance
{
	...
	public static TaoKeeperSettings taoKeeperSettings = new TaoKeeperSettings(0, "不应该不出我，除非数据库出问题", 2,
			"不应该不出我，除非数据库出问题");
	...
	public static Map<String, Connection> getZooKeeperClientConnectionMapByClusterIdAndServerIp(
			String clusterIdAndServerIp)
	{
	...
	public static void putZooKeeperClientConnectionMapByClusterIdAndServerIp(String clusterIdAndServerIp,
