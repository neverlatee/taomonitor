...
public class SystemConstant
{
	...
	{
		SystemConstant.dataStoreBasePath = StringUtil.defaultIfBlank(dataStoreBasePath,
				SystemConstant.dataStoreBasePath);
	}
	...
	public static void parseConfigOfMsgCenter(String configOfMsgCenter)
	{
		try
		{
			...
			SystemConstant.serverOfMsgCenter = StringUtil.defaultIfBlank(configOfMsgCenterArray[0],
					SystemConstant.serverOfMsgCenter);
			SystemConstant.sourceIdOfMsgCenter = StringUtil.defaultIfBlank(configOfMsgCenterArray[1],
					SystemConstant.sourceIdOfMsgCenter);
		...
		catch (Exception e)
		{
			throw new RuntimeException("Parse configOfMsgCenter( " + configOfMsgCenter
					+ " ) error, please config like this：1.2.3.4:9999,1.2.3.5:9999/a*b/3545656/67657" + e.getMessage(),
					e);
		}
	}
