...
public class ZooKeeperClusterMapDumpJob implements Runnable
{
	...
	public ZooKeeperClusterMapDumpJob()
	{

	}

	public ZooKeeperClusterMapDumpJob(CountDownLatch countDownLatch)
	{
	...
	public void run()
	{
		while (true)
		{
			try
			{
				ThreadPoolManager.addJobToZKClusterDumperExecutor(new ZKClusterConfigDumper(countDownLatch));
